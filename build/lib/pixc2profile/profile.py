...
class Profile:
    ...
    def __init__(self,
        ...
        Args:
            ...
            wse_upper_limit: Upper limit for WSE values. Defaults to None.
            wse_lower_limit: Lower limit for WSE values. Defaults to None.
        ...
        # WSE limits
        self.wse_upper_limit = wse_upper_limit
        self.wse_lower_limit = wse_lower_limit
